...
<body>
	...
	<form action="CompanyExpense_edit_submit" method="post">
		<div class="form-group">
			<label for="email">id:</label> <input type="text"
				class="form-control" id="id"
				placeholder="Enter OpeningAmount" value='${u.getId() }' readonly name="id" required>
		</div>
		<div class="form-group">
			<label for="email">OpeningAmount:</label> <input type="text"
				class="form-control" id="OpeningAmount"
				placeholder="Enter OpeningAmount" value='${u.getOpeningAmount() }' name="OpeningAmount" required>
		</div>
		<div class="form-group">
