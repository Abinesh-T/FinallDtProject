...
<body>
	...
	<form action="ProductUploadEdit" method="post">
		...
		<div class="form-group">
			...
			<div>
				<label for="pwd">RetailerBillingRate :</label> <input type="text"
					...
					name="RetailerBillingRate" onkeyup="sum();" value='${u.getRetailerBillingRate() }' readonly required>
			</div>
